<div align="center">
  ...
  <h3 align="center">Mock Muse: A job interview preparation platform powered by Vapi AI Voice agents</h3>
...
Built with Next.js for the user interface and backend logic, Firebase for authentication and data storage, styled with TailwindCSS and using Vapi's voice agents, Mock Muse is a website project designed to help you learn integrating AI models with your apps. The platform offers a sleek and modern experience for job interview preparation.
...
Public assets used in the project can be found in the project's assets folder.
